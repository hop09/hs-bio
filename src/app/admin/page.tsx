...
export default async function AdminPage() {
  ...
  return <main className="admin-page"><aside className="admin-sidebar"><Link href="/" className="brand-mark"><span>HS</span> Bio</Link><nav><Link href="/admin" className="active"><Settings2 size={18}/>Profiles</Link></nav><div><ThemeSwitcher compact/><form action={logoutAction}><button><LogOut size={17}/>Sign out</button></form></div></aside>
